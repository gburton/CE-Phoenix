...
<div class="contentContainer">
  <div class="contentText">
    ...
    <div class="form-group has-feedback">
      <span class="hidden-xs"><label for="inputFromName" class="control-label col-xs-3"><?php echo ENTRY_NAME; ?></label></span>
    ...
    <div class="form-group has-feedback">
      <span class="hidden-xs"><label for="inputFromEmail" class="control-label col-xs-3"><?php echo ENTRY_EMAIL; ?></label></span>
      <div class="col-xs-12 col-sm-9">
        <?php
    ...
    <div class="form-group has-feedback">
      <span class="hidden-xs"><label for="inputEnquiry" class="control-label col-xs-3"><?php echo ENTRY_ENQUIRY; ?></label></span>
      <div class="col-xs-12 col-sm-9">
        <?php
