...
<div class="contentContainer">
  <div class="contentText">
    ...
    <div class="form-group has-feedback">
      ...
      <div class="col-xs-9">
        <?php
        echo tep_draw_input_field('name', NULL, 'required autofocus="autofocus" aria-required="true" id="inputFromName"');
    ...
    <div class="form-group has-feedback">
      ...
      <div class="col-xs-9">
        <?php
        echo tep_draw_input_field('email', NULL, 'required aria-required="true" id="inputFromEmail"');
        echo FORM_REQUIRED_INPUT;
        ?>
      </div>
    </div>
    <div class="form-group has-feedback">
      ...
      <div class="col-xs-9">
        <?php
        echo tep_draw_textarea_field('enquiry', 'soft', 50, 15, NULL, 'required aria-required="true" id="inputEnquiry"');
        echo FORM_REQUIRED_INPUT;
        ?>
      </div>
    </div>
