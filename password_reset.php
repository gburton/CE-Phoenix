...
<div class="contentContainer">
  <div class="contentText">
    ...
    <div class="form-group has-feedback">
      ...
      <div class="col-sm-9">
        <?php echo tep_draw_input_field('password', NULL, 'required aria-required="true"  autofocus="autofocus" id="inputPassword" placeholder="' . ENTRY_PASSWORD_TEXT . '"', 'password'); ?>
    ...
    <div class="form-group has-feedback">
      ...
      <div class="col-sm-9">
        <?php echo tep_draw_input_field('confirmation', NULL, 'required aria-required="true" id="inputConfirm" placeholder="' . ENTRY_PASSWORD_CONFIRMATION_TEXT . '"', 'password'); ?>
        <?php echo FORM_REQUIRED_INPUT; ?>
      </div>
    </div>
  </div>
