...
<div class="contentContainer">
  <div class="contentText">
    ...
    <div class="form-group has-feedback">
      ...
      <div class="col-xs-9">
        <?php echo tep_draw_input_field('password', NULL, 'required aria-required="true"  autofocus="autofocus" id="inputPassword"'); ?>
    ...
    <div class="form-group has-feedback">
      ...
      <div class="col-xs-9">
        <?php echo tep_draw_input_field('confirmation', NULL, 'required aria-required="true" id="inputConfirm"'); ?>
        <?php echo FORM_REQUIRED_INPUT; ?>
      </div>
    </div>
  </div>
