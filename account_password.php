...
<div class="contentContainer">
  ...
  <div class="contentText">
    <div class="form-group has-feedback">
      <label for="inputCurrent" class="control-label col-xs-12 col-sm-3"><?php echo ENTRY_PASSWORD_CURRENT; ?></label>
    ...
    <div class="form-group has-feedback">
      <label for="inputNew" class="control-label col-xs-12 col-sm-3"><?php echo ENTRY_PASSWORD_NEW; ?></label>
      <div class="col-xs-12 col-sm-9">
    ...
    <div class="form-group has-feedback">
      <label for="inputConfirmation" class="control-label col-xs-12 col-sm-3"><?php echo ENTRY_PASSWORD_CONFIRMATION; ?></label>
      <div class="col-xs-12 col-sm-9">
