...
<div class="contentContainer">
  ...
  <div class="contentText">
    <div class="form-group has-feedback">
      <span class="hidden-xs"><label for="inputCurrent" class="control-label col-xs-3"><?php echo ENTRY_PASSWORD_CURRENT; ?></label></span>
    ...
    <div class="form-group has-feedback">
      <span class="hidden-xs"><label for="inputNew" class="control-label col-xs-3"><?php echo ENTRY_PASSWORD_NEW; ?></label></span>
      <div class="col-xs-12 col-sm-9">
