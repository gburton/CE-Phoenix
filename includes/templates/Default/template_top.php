...
<?php   
	  if (file_exists('includes/templates/' . TEMPLATE . '/header.php') && file_exists('includes/templates/' . TEMPLATE . '/footer.php')) {
		require('includes/templates/' . TEMPLATE . '/header.php');
			} else {
