...
// Display a banner from the specified group or banner id ($identifier)
  function tep_display_banner($action, $identifier) {
    ...
    if (tep_not_null($banner['banners_html_text'])) {
      ...
      $banner_string = '<a href="' . tep_href_link('redirect.php', 'action=banner&goto=' . $banner['banners_id']) . '" target="_blank" rel="noopener">' . tep_image('images/' . $banner['banners_image'], htmlspecialchars($banner['banners_title'])) . '</a>';
    }
