...
define('JQUERY_DATEPICKER_I18N_CODE', ''); // leave empty for en_US; see http://bootstrap-datepicker.readthedocs.org/en/release/options.html#language
// BOOTSTRAP_DATEPICKER_FORMAT: yyyy = 4-digit years, yy = 2-digit years.
// JQUERY_DATEPICKER_FORMAT (admin side): yy = 4-digit years, y = 2-digit years.
