...
*/
  ...
  define('MODULE_PAYMENT_STRIPE_TEXT_DESCRIPTION', '<i class="fas fa-info-circle"></i>&nbsp;<a href="http://library.oscommerce.com/Package&en&stripe&oscom23&stripe_js" target="_blank" rel="noopener" style="text-decoration: underline; font-weight: bold;">View Online Documentation</a><br><br><i class="fas fa-external-link-alt"></i>&nbsp;<a href="https://www.stripe.com" target="_blank" rel="noopener" style="text-decoration: underline; font-weight: bold;">Visit Stripe Website</a>');
