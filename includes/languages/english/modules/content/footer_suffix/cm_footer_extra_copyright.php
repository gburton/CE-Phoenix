...
*/
  ...
  define('FOOTER_TEXT_BODY', '<p>Copyright &copy; ' . date('Y') . ' <a href="' . tep_href_link('index.php') . '">' . STORE_NAME . '</a> Powered by <a href="http://www.oscommerce.com" target="_blank" rel="noopener">osCommerce</a></p>');
