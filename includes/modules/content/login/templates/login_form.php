<div class="contentContainer <?php echo (MODULE_CONTENT_LOGIN_FORM_CONTENT_WIDTH == 'Half') ? 'col-sm-6 col-md-6' : 'col-md-12'; ?>">
  ...
  <div class="contentText">
    ...
    <?php echo tep_draw_form('login', tep_href_link(FILENAME_LOGIN, 'action=process', 'SSL'), 'post', '', true); ?>
      ...
      <p class="text-right"><?php echo tep_draw_button(IMAGE_BUTTON_LOGIN, 'glyphicon-log-in', null, 'primary', NULL, 'btn-primary'); ?></p>
