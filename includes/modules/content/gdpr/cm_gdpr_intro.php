  ...
  class cm_gdpr_intro {
    ...
    function __construct() {
      ...
      if ( defined('MODULE_CONTENT_GDPR_INTRO_STATUS') ) {
        ...
        $this->enabled = (MODULE_CONTENT_GDPR_INTRO_STATUS == 'True');
      }
    }
    ...
    function execute() {
      ...
      $content_width = (int)MODULE_CONTENT_GDPR_INTRO_CONTENT_WIDTH;
    ...
    function check() {
      return defined('MODULE_CONTENT_GDPR_INTRO_STATUS');
    }
    ...
    function install() {
      ...
      tep_db_query("insert into configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_CONTENT_GDPR_INTRO_SORT_ORDER', '50', 'Sort order of display. Lowest is displayed first.', '6', '3', now())");
    }
    ...
    function keys() {
      return array('MODULE_CONTENT_GDPR_INTRO_STATUS', 'MODULE_CONTENT_GDPR_INTRO_CONTENT_WIDTH', 'MODULE_CONTENT_GDPR_INTRO_SORT_ORDER');
    }
  }
