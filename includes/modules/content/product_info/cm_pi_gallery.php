...
*/
  ...
  class cm_pi_gallery {
    ...
    function keys() {
      return array('MODULE_CONTENT_PRODUCT_INFO_GALLERY_STATUS', 'MODULE_CONTENT_PRODUCT_INFO_GALLERY_CONTENT_WIDTH', 'MODULE_CONTENT_PRODUCT_INFO_GALLERY_SORT_ORDER');
    }
  }
