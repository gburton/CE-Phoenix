  ...
  class cm_pi_options {
    ...
    function execute() {
      ...
      if ($products_attributes['total'] > 0) {
        ...
        $product_options .= '<h4>' . TEXT_PRODUCT_OPTIONS . '</h4>';
        $product_options .= '<p>';
    ...
    function install() {
      ...
      tep_db_query("insert into configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_CONTENT_PRODUCT_INFO_OPTIONS_SORT_ORDER', '0', 'Sort order of display. Lowest is displayed first.', '6', '0', now())");
    }
    ...
    function keys() {
      return array('MODULE_CONTENT_PRODUCT_INFO_OPTIONS_STATUS', 'MODULE_CONTENT_PRODUCT_INFO_OPTIONS_CONTENT_WIDTH', 'MODULE_CONTENT_PRODUCT_INFO_OPTIONS_SORT_ORDER');
    }
  }
