...
*/
  ...
  class cm_pi_also_purchased {
    ...
    function execute() {
      global $oscTemplate, $product_info, $SID, $HTTP_GET_VARS, $languages_id;
    ...
    function keys() {
      return array('MODULE_CONTENT_PRODUCT_INFO_ALSO_PURCHASED_STATUS', 'MODULE_CONTENT_PRODUCT_INFO_ALSO_PURCHASED_CONTENT_WIDTH', 'MODULE_CONTENT_PRODUCT_INFO_ALSO_PURCHASED_SORT_ORDER');
    }
  }
