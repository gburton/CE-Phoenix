    ...
    protected function get_parameters() {
      return [
        ...
        'MODULE_CONTENT_IN_CATEGORY_LISTING_LAYOUT' => [
          ...
          'value' => 'card-deck',
          'desc' => <<<'EOD'
What Layout suits your shop?  See https://getbootstrap.com/docs/4.4/components/card/#card-layout 
<div class="alert alert-warning">card-columns is a special use case that will not suit most shops as card-columns is very difficult to lay out and sort by...</div>
EOD
          ,
