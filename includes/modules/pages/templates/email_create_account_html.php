                    ...
                    <tr>
                      <td align="center" valign="top" class="mobilePadding" style=" padding-top:40px; padding-right:40px; padding-bottom:30px; padding-left:40px;">
                        ...
                        <table id="content" width="100%">
                          <tr><td><?php echo EMAIL_WELCOME; ?></td></tr>
                          <tr><td><ul style="list-style:none; padding-left:10px;"><?php echo EMAIL_TEXT; ?></ul></td></tr>
                          <tr><td><?php echo str_replace(STORE_OWNER_EMAIL_ADDRESS . '.', '', EMAIL_CONTACT); ?><a href="mailto:<?php echo STORE_OWNER_EMAIL_ADDRESS; ?>?Subject=<?php echo NAVBAR_TITLE; ?>"><?php echo EMAIL_MAIL_TO; ?></a></td></tr>
