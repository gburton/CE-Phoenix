...
*/
  ...
  class authorizenet_cc_aim extends abstract_payment_module {

    const CONFIG_KEY_BASE = 'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_';
    ...
    private $signature = 'authorizenet|authorizenet_cc_aim|2.0|2.3';
    ...
    public function __construct() {
      ...
      if ( !tep_not_null(MODULE_PAYMENT_AUTHORIZENET_CC_AIM_LOGIN_ID) || !tep_not_null(MODULE_PAYMENT_AUTHORIZENET_CC_AIM_TRANSACTION_KEY) ) {
        $this->description = '<div class="alert alert-warning">' . MODULE_PAYMENT_AUTHORIZENET_CC_AIM_ERROR_ADMIN_CONFIGURATION . '</div>' . $this->description;

        $this->enabled = false;
      }

      if ( !function_exists('curl_init') ) {
        $this->description = '<div class="alert alert-warning">' . MODULE_PAYMENT_AUTHORIZENET_CC_AIM_ERROR_ADMIN_CURL . '</div>' . $this->description;
    ...
    public function confirmation() {
      ...
      $confirmation = [
        'fields' => [
          [
            'title' => MODULE_PAYMENT_AUTHORIZENET_CC_AIM_CREDIT_CARD_OWNER_FIRSTNAME,
    ...
    public function after_process() {
      global $response, $order, $order_id;
    ...
    protected function get_parameters() {
      $params = [
        'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_STATUS' => [
          'title' => 'Enable Authorize.net Advanced Integration Method',
        ...
        'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_TRANSACTION_ORDER_STATUS_ID' => [
          'title' => 'Transaction Order Status',
          'desc' => 'Include transaction information in this order status level',
          'value' => self::ensure_order_status('MODULE_PAYMENT_AUTHORIZENET_CC_AIM_TRANSACTION_ORDER_STATUS_ID', 'Authorize.net [Transactions]'),
          'use_func' => 'tep_get_order_status_name',
          'set_func' => 'tep_cfg_pull_down_order_statuses(',
        ],
        ...
        'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_VERIFY_SSL' => [
        ...
        'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_DEBUG_EMAIL' => [
...
EOD;
      ...
      $info = '<p><i class="fas fa-lock"></i>&nbsp;<a href="javascript:openTestConnectionDialog();" style="text-decoration: underline; font-weight: bold;">' . MODULE_PAYMENT_AUTHORIZENET_CC_AIM_DIALOG_CONNECTION_LINK_TITLE . '</a></p>' .
