...
// class constructor
    function __construct() {
      ...
      $this->sort_order = defined('MODULE_PAYMENT_SOFORTUEBERWEISUNG_DIRECT_SORT_ORDER') ? MODULE_PAYMENT_SOFORTUEBERWEISUNG_DIRECT_SORT_ORDER : 0;
      $this->enabled = defined('MODULE_PAYMENT_SOFORTUEBERWEISUNG_DIRECT_STATUS') && ((MODULE_PAYMENT_SOFORTUEBERWEISUNG_DIRECT_STATUS == 'True') ? true : false);

      if (defined('MODULE_PAYMENT_SOFORTUEBERWEISUNG_DIRECT_PREPARE_ORDER_STATUS_ID') && (int)MODULE_PAYMENT_SOFORTUEBERWEISUNG_DIRECT_PREPARE_ORDER_STATUS_ID > 0) {
