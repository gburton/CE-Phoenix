...
*/
  ...
  class stripe {
    ...
    function getParams() {
      if ( tep_db_num_rows(tep_db_query("show tables like ':table_customers_stripe_tokens'")) != 1 ) {
        $sql = <<<EOD
CREATE TABLE :table_customers_stripe_tokens (
...
EOD;
    ...
    function createCustomer($token) {
      ...
      if ( is_array($result) && !empty($result) && isset($result['object']) && ($result['object'] == 'customer') ) {
        ...
        tep_db_perform(':table_customers_stripe_tokens', $sql_data_array);
