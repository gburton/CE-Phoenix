...
*/
  ...
  class sage_pay_server {
    ...
    function before_process() {
      global $HTTP_GET_VARS, $sagepay_server_skey_code, $sagepay_server_transaction_details, $sage_pay_server_nexturl, $customer_id, $order, $currency, $order_totals, $cartID;
