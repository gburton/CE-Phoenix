...
?>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <?php
        echo tep_draw_input_field('firstname', NULL, 'id="inputFirstName"');
    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <?php
        echo tep_draw_input_field('lastname', NULL, 'id="inputLastName"');
...
?>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <?php
        echo tep_draw_input_field('street_address', NULL, 'id="inputStreet"');
...
?>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <?php
        echo tep_draw_input_field('city', NULL, 'id="inputCity"');
    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <?php
        echo tep_draw_input_field('postcode', NULL, 'id="inputZip"');
