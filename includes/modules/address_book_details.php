...
?>
      ...
      <div class="form-group has-feedback">
        ...
        <div class="col-xs-9">
          <?php echo tep_draw_input_field('firstname', (isset($entry['entry_firstname']) ? $entry['entry_firstname'] : ''), 'required aria-required="true" id="inputFirstName"'); ?>
          <?php echo FORM_REQUIRED_INPUT; ?>
      ...
      <div class="form-group has-feedback">
        ...
        <div class="col-xs-9">
          <?php echo tep_draw_input_field('lastname', (isset($entry['entry_lastname']) ? $entry['entry_lastname'] : ''), 'required aria-required="true" id="inputLastName"'); ?>
          <?php echo FORM_REQUIRED_INPUT; ?>
...
?>
      ...
      <div class="form-group">
        ...
        <div class="col-xs-9">
          <?php
          echo tep_draw_input_field('company', (isset($entry['entry_company']) ? $entry['entry_company'] : ''), 'id="inputCompany" placeholder="' . ENTRY_OPTIONAL . '"');
...
?>
      ...
      <div class="form-group has-feedback">
        ...
        <div class="col-xs-9">
          <?php
          echo tep_draw_input_field('street_address', (isset($entry['entry_street_address']) ? $entry['entry_street_address'] : ''), 'required aria-required="true" id="inputStreet"');
...
?>
      ...
      <div class="form-group">
        ...
        <div class="col-xs-9">
          <?php
          echo tep_draw_input_field('suburb', (isset($entry['entry_suburb']) ? $entry['entry_suburb'] : ''), 'id="inputSuburb" placeholder="' . ENTRY_OPTIONAL . '"');
...
?>
      ...
      <div class="form-group has-feedback">
        ...
        <div class="col-xs-9">
          <?php
          echo tep_draw_input_field('city', (isset($entry['entry_city']) ? $entry['entry_city'] : ''), 'required aria-required="true" id="inputCity"');
          echo FORM_REQUIRED_INPUT;
      ...
      <div class="form-group has-feedback">
        ...
        <div class="col-xs-9">
          <?php
          echo tep_draw_input_field('postcode', (isset($entry['entry_postcode']) ? $entry['entry_postcode'] : ''), 'required aria-required="true" id="inputZip"');
          echo FORM_REQUIRED_INPUT;
      ...
      <div class="form-group">
        ...
        <div class="col-xs-9">
          ...
          if ($process == true) {
            ...
            echo tep_draw_input_field('state', (isset($entry['entry_country_id']) ? tep_get_zone_name($entry['entry_country_id'], $entry['entry_zone_id'], $entry['entry_state']) : ''), 'required aria-required="true" id="inputState" placeholder="' . ENTRY_OPTIONAL . '"');
          }
