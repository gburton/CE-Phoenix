...
?>
      ...
      <div class="form-group has-feedback">
        ...
        <div class="col-sm-9">
          <?php echo tep_draw_input_field('firstname', (isset($entry['entry_firstname']) ? $entry['entry_firstname'] : ''), 'required aria-required="true" id="inputFirstName" minlength="' . (int)ENTRY_FIRST_NAME_MIN_LENGTH . '" placeholder="' . ENTRY_FIRST_NAME . '"'); ?>
          <?php echo FORM_REQUIRED_INPUT; ?>
