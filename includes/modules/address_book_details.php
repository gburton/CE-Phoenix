...
?>
      ...
      <div class="form-group has-feedback">
        ...
        <div class="col-sm-9">
          <?php echo tep_draw_input_field('firstname', (isset($entry['entry_firstname']) ? $entry['entry_firstname'] : ''), 'id="inputFirstName" placeholder="' . ENTRY_FIRST_NAME_TEXT . '" autocomplete="given-name"'); ?>
          <?php echo FORM_REQUIRED_INPUT; ?>
        </div>
      </div>
      <div class="form-group has-feedback">
        ...
        <div class="col-sm-9">
          <?php echo tep_draw_input_field('lastname', (isset($entry['entry_lastname']) ? $entry['entry_lastname'] : ''), 'id="inputLastName" placeholder="' . ENTRY_LAST_NAME_TEXT . '" autocomplete="family-name"'); ?>
          <?php echo FORM_REQUIRED_INPUT; ?>
        </div>
      </div>
...
?>
      ...
      <div class="form-group has-feedback">
        ...
        <div class="col-sm-9">
          <?php
          echo tep_draw_input_field('street_address', (isset($entry['entry_street_address']) ? $entry['entry_street_address'] : ''), 'id="inputStreet" placeholder="' . ENTRY_STREET_ADDRESS_TEXT . '"  autocomplete="address-line1"');
...
?>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <?php
          echo tep_draw_input_field('suburb', (isset($entry['entry_suburb']) ? $entry['entry_suburb'] : ''), 'id="inputSuburb" placeholder="' . ENTRY_SUBURB_TEXT . '" autocomplete="address-line2"');
          ?>
        </div>
      </div>
...
?>
      ...
      <div class="form-group has-feedback">
        ...
        <div class="col-sm-9">
          <?php
          echo tep_draw_input_field('city', (isset($entry['entry_city']) ? $entry['entry_city'] : ''), 'id="inputCity" placeholder="' . ENTRY_CITY_TEXT . '" autocomplete="address-level2"');
          echo FORM_REQUIRED_INPUT;
          ?>
        </div>
      </div>
      <div class="form-group has-feedback">
        ...
        <div class="col-sm-9">
          <?php
          echo tep_draw_input_field('postcode', (isset($entry['entry_postcode']) ? $entry['entry_postcode'] : ''), 'id="inputZip" placeholder="' . ENTRY_POST_CODE_TEXT . '" autocomplete="postal-code"');
          echo FORM_REQUIRED_INPUT;
          ?>
       </div>
      </div>
        ...
        <div class="col-sm-9">
          ...
          if ($process == true) {
            if ($entry_state_has_zones == true) {
              ...
              echo tep_draw_pull_down_menu('state', $zones_array, 0, 'id="inputState" aria-describedby="atState" autocomplete="address-level1"');
              if (tep_not_null(ENTRY_STATE_TEXT)) echo '<span id="atState" class="help-block">' . ENTRY_STATE_TEXT . '</span>';
            } else {
              echo tep_draw_input_field('state', NULL, 'id="inputState" placeholder="' . ENTRY_STATE_TEXT . '" autocomplete="address-level1"');
            }
          } else {
            echo tep_draw_input_field('state', (isset($entry['entry_country_id']) ? tep_get_zone_name($entry['entry_country_id'], $entry['entry_zone_id'], $entry['entry_state']) : ''), 'id="inputState" placeholder="' . ENTRY_STATE_TEXT . '" autocomplete="address-level1"');
          }
          ?>
        </div>
      </div>
...
?>
      ...
      <div class="form-group has-feedback">
        ...
        <div class="col-sm-9">
          <?php
          echo tep_get_country_list('country', (isset($entry['entry_country_id']) ? $entry['entry_country_id'] : 0), 'aria-describedby="atCountry" id="inputCountry" autocomplete="country"');
          echo FORM_REQUIRED_INPUT;
