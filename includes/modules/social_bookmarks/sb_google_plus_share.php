...
*/
  ...
  class sb_google_plus_share {
    ...
    function getOutput() {
      ...
      $output = '<div class="g-plus" data-action="share" data-href="' . tep_href_link('product_info.php', 'products_id=' . $HTTP_GET_VARS['products_id'], 'NONSSL', false) . '" data-annotation="' . strtolower(MODULE_SOCIAL_BOOKMARKS_GOOGLE_PLUS_SHARE_ANNOTATION) . '"';
