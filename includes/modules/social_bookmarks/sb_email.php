...
*/
  ...
  class sb_email {
    ...
    function getOutput() {
      ...
      return '<a href="' . tep_href_link('tell_a_friend.php', 'products_id=' . $HTTP_GET_VARS['products_id']) . '"><img src="' . DIR_WS_IMAGES . 'social_bookmarks/' . $this->icon . '" border="0" title="' . tep_output_string_protected($this->public_title) . '" alt="' . tep_output_string_protected($this->public_title) . '" /></a>';
    }
