...
*/
  ...
  class sb_facebook {
    ...
    function getOutput() {
      return '<a href="http://www.facebook.com/share.php?u=' . urlencode(tep_href_link('product_info.php', 'products_id=' . $_GET['products_id'], 'NONSSL', false)) . '" target="_blank" rel="noopener"><img src="images/social_bookmarks/' . $this->icon . '" border="0" title="' . tep_output_string_protected($this->public_title) . '" alt="' . tep_output_string_protected($this->public_title) . '" /></a>';
    }
