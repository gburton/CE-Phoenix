  ...
  if (isset($HTTP_GET_VARS['products_id'])) {
    ...
    if ($num_products_ordered >= MIN_DISPLAY_ALSO_PURCHASED) {
      ...
      while ($orders = tep_db_fetch_array($orders_query)) {
        ...
        $also_pur_prods_content .= '      <h5 class="text-center"><a href="' . tep_href_link('product_info.php', 'products_id=' . $orders['products_id']) . '">' . $orders['products_name'] . '</a></h5>';
