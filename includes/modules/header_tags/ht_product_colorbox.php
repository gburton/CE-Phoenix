...
*/
  ...
  class ht_product_colorbox {
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Image Layout', 'MODULE_HEADER_TAGS_PRODUCT_COLORBOX_IMG_LAYOUT', '125', 'Image Layout on Product Page (eg, 125 = 1st row: 1 image, 2nd row: 2 images, 3rd row: 5 images, Further rows: no images).  NOTE:  Maximum of 5 images on any row!', '6', '1', now())");
