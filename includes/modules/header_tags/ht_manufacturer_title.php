        ...
        if (isset($HTTP_GET_VARS['manufacturers_id']) && is_numeric($HTTP_GET_VARS['manufacturers_id'])) {
          ...
          if (tep_db_num_rows($manufacturers_query)) {
            ...
            if (tep_not_null($manufacturers['manufacturers_seo_title'])) {
              $oscTemplate->setTitle($manufacturers['manufacturers_seo_title'] . MODULE_HEADER_TAGS_PAGES_SEO_SEPARATOR . $oscTemplate->getTitle());
            }
            else {
              $oscTemplate->setTitle($manufacturers['manufacturers_name'] . MODULE_HEADER_TAGS_PAGES_SEO_SEPARATOR . $oscTemplate->getTitle());
            }
          }
        }
      }
