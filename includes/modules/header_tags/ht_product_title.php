        ...
        if (isset($HTTP_GET_VARS['products_id'])) {
          if ($product_check['total'] > 0) {
            ...
            if (tep_not_null($product_info['products_seo_title'])) {
              $oscTemplate->setTitle($product_info['products_seo_title'] . MODULE_HEADER_TAGS_PAGES_SEO_SEPARATOR . $oscTemplate->getTitle());
            }
            else {
              $oscTemplate->setTitle($product_info['products_name'] . MODULE_HEADER_TAGS_PAGES_SEO_SEPARATOR . $oscTemplate->getTitle());
            }
          }
        }
      }
