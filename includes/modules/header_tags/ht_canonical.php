  ...
  class ht_canonical {
    ...
    function execute() {
      ...
      if (basename($PHP_SELF) == 'product_info.php') {
        $oscTemplate->addBlock('<link rel="canonical" href="' . tep_href_link('product_info.php', 'products_id=' . (int)$HTTP_GET_VARS['products_id'], 'NONSSL', false) . '" />' . "\n", $this->group);
        ...
        if (isset($cPath) && tep_not_null($cPath)) {
          ...
          $oscTemplate->addBlock('<link rel="canonical" href="' . tep_href_link('index.php', 'manufacturers_id=' . (int)$HTTP_GET_VARS['manufacturers_id'], 'NONSSL', false) . '" />' . "\n", $this->group);
        }
      }
    }
