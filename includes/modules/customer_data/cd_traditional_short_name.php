      ...
      switch ($field) {
        ...
        case 'greeting':
          if (!isset($customer_details[$field])) {
            ...
            if ($gender !== null && $GLOBALS['customer_data']->get('lastname', $customer_details) !== null) {
              if ('m' === $gender) {
                $customer_details[$field] = sprintf(EMAIL_GREET_MR, $GLOBALS['customer_data']->get('lastname', $customer_details));
              } elseif ('f' === $gender) {
                $customer_details[$field] = sprintf(EMAIL_GREET_MS, $GLOBALS['customer_data']->get('lastname', $customer_details));
              }
            }

            $customer_details[$field] = sprintf(EMAIL_GREET_NONE, $GLOBALS['customer_data']->get('short_name', $customer_details));
          }
