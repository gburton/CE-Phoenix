  ...
  class bm_whats_new {
    ...
    function bm_whats_new() {
      ...
      if ( defined('MODULE_BOXES_WHATS_NEW_STATUS') ) {
        ...
        switch (MODULE_BOXES_WHATS_NEW_CONTENT_PLACEMENT) {
          case 'Left Column':
      ...
      if ($random_product = tep_random_select("select products_id, products_image, products_tax_class_id, products_price from " . TABLE_PRODUCTS . " where products_status = '1' order by products_date_added desc limit " . MAX_RANDOM_SELECT_NEW)) {
        ...
        if ($this->group == 'boxes_footer') {
          $data =  '<div class="col-sm-3 col-lg-2">' .
                   '  <div class="footerbox best-sellers">' .
                   '    <h2><a href="' . tep_href_link(FILENAME_PRODUCTS_NEW) . '">' . MODULE_BOXES_WHATS_NEW_BOX_TITLE . '</a></h2>';
        }
        else {
