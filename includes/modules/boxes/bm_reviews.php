...
// display 'write a review' box
        $reviews_box_contents .= '<span class="fa fa-thumbs-up"></span> <a href="' . tep_href_link('product_reviews_write.php', 'products_id=' . $HTTP_GET_VARS['products_id']) . '">' . MODULE_BOXES_REVIEWS_BOX_WRITE_REVIEW .'</a>';
      } else {
