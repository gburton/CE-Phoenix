    ...
    function execute() {
      $form_output = tep_draw_form('quick_find', tep_href_link('advanced_search_result.php', '', null, false), 'get');
        $form_output .= '<div class="input-group">';
          $form_output .= tep_draw_input_field('keywords', '', 'required="required" aria-required="true" autocomplete="off" list="search" placeholder="' . TEXT_SEARCH_PLACEHOLDER . '"', 'search');
