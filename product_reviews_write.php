...
?>
  ...
  <div class="contentText">
    ...
    <div class="form-group has-feedback">
      <label for="inputReview" class="control-label col-xs-12 col-sm-3"><?php echo SUB_TITLE_REVIEW; ?></label>
  ...
  <div class="buttonSet">
    ...
    <?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'glyphicon glyphicon-chevron-left', tep_href_link(FILENAME_PRODUCT_REVIEWS, tep_get_all_get_params(array('reviews_id', 'action')))); ?>
  </div>
</div>
