...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_BOXES_GREETING_SORT_ORDER', '1000', 'Sort order of display. Lowest is displayed first.', '6', '0', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_BOXES_WHATS_NEW_CONTENT_SORT_ORDER', '1010', 'Sort order of display. Lowest is displayed first.', '6', '0', now());
