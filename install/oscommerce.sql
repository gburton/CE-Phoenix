...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Minimum to Display', 'MODULES_BOXES_BEST_SELLERS_MAX_DISPLAY', '10', 'Maximum number of best sellers to display', '6', '3', NOW());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Bootstrap Container', 'BOOTSTRAP_CONTAINER', 'container-fluid', 'What type of container should the page content be shown in? See https://getbootstrap.com/docs/4.4/layout/overview/#containers', '16', '1', 'tep_cfg_select_option(array(\'container\', \'container-sm\', \'container-md\', \'container-lg\', \'container-xl\', \'container-fluid\'), ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Installed Modules', 'MODULE_ADMIN_DASHBOARD_INSTALLED', 'd_orders.php;d_customers.php;d_phoenix_addons.php;d_security_checks.php;d_latest_news.php;d_admin_logins.php;d_version_check.php;d_reviews.php;d_partner_news.php;d_latest_addons.php', 'List of Administration Tool Dashboard module filenames separated by a semi-colon. This is automatically updated. No need to edit.', '6', '0', now());
...
insert into configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Addons to display', 'MODULE_ADMIN_DASHBOARD_LATEST_ADDONS_DISPLAY', '5', 'This number of Addons will display, ordered by latest published.', '6', '2', now());
...
insert into configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_ADMIN_DASHBOARD_LATEST_ADDONS_SORT_ORDER', '1200', 'Sort order of display. Lowest is displayed first.', '6', '4', now());
...
insert into configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_BOXES_REVIEWS_SORT_ORDER', '5040', 'Sort order of display. Lowest is displayed first.', '6', '1', now());
...
insert into configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Icons', 'MODULE_CONTENT_FOOTER_EXTRA_ICONS_DISPLAY', 'apple-pay,bitcoin,cc-paypal,cc-stripe', 'Icons to display.', '6', '0', now());
...
insert into configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Sort Order', 'MODULE_CONTENT_UPCOMING_PRODUCTS_EXPECTED_SORT', 'desc', 'This is the sort order used in the output.', '6', '4', 'tep_cfg_select_option(array(\'asc\', \'desc\'), ', now());
insert into configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Sort Field', 'MODULE_CONTENT_UPCOMING_PRODUCTS_EXPECTED_FIELD', 'date_expected', 'The column to sort by in the output.', '6', '5', 'tep_cfg_select_option(array(\'products_name\', \'date_expected\'), ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_FIRSTNAME_PAGES', 'account_edit;address_book;checkout_new_address', 'On what pages should this appear?', '6', '5', 'NOW()', 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_STREET_ADDRESS_PAGES', 'address_book;checkout_new_address', 'On what pages should this appear?', '6', '5', 'NOW()', 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_CITY_PAGES', 'address_book;checkout_new_address', 'On what pages should this appear?', '6', '5', 'NOW()', 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('`configuration_title`', '`configuration_key`', '`configuration_value`', '`configuration_description`', '`configuration_group_id`', '`sort_order`', 'NOW()', '`use_function`', '`set_function`) VALU');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_STATE_PAGES', 'address_book;checkout_new_address', 'On what pages should this appear?', '6', '5', 'NOW()', 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_POST_CODE_PAGES', 'address_book;checkout_new_address', 'On what pages should this appear?', '6', '5', 'NOW()', 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, set_function) VALUES ('Enable Last Name module', 'MODULE_CUSTOMER_DATA_COUNTRY_STATUS', 'True', 'Do you want to add the module to your shop?', '6', '1', 'NOW()', 'tep_cfg_select_option([\'True\', \'False\'], ');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, set_function) VALUES ('Require Last Name module (if enabled)', 'MODULE_CUSTOMER_DATA_COUNTRY_REQUIRED', 'True', 'Do you want the country to be required in customer registration?', '6', '3', 'NOW()', 'tep_cfg_select_option([\'True\', \'False\'], ');
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_COUNTRY_PAGES', 'address_book;checkout_new_address', 'On what pages should this appear?', '6', '4', 'NOW()', 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_EMAIL_ADDRESS_PAGES', 'account_edit', 'On what pages should this appear?', '6', '5', 'NOW()', 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, set_function) VALUES ('Enable Password module', 'MODULE_CUSTOMER_DATA_PASSWORD_CONFIRMATION_STATUS', 'True', 'Do you want to add the module to your shop?', '6', '1', 'NOW()', 'tep_cfg_select_option([\'True\', \'False\'], ');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_PASSWORD_CONFIRMATION_PAGES', 'account_password', 'On what pages should this appear?', '6', '3', 'NOW()', 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Pages', 'MODULE_CUSTOMER_DATA_TELEPHONE_PAGES', 'account_edit', 'On what pages should this appear?', '6', '5', 'NOW()', 'abstract_module::list_exploded', 'tep_draw_account_edit_pages(');
