...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Switch status off', 'STATUS_SWITCH_OFF', 'true', 'Switch product status off in checkout if stock reaches zero', '9', '6', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());
