...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_CONTENT_HEADER_NOSCRIPT_SORT_ORDER', '11', 'Sort order of display. Lowest is displayed first.', '6', '0', now());
