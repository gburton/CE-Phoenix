...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Product Card Layout', 'IS_PRODUCT_PRODUCTS_LAYOUT', 'card-deck', 'What Layout suits your shop?  See <a target="_blank" href="https://getbootstrap.com/docs/4.4/components/card/#card-layout"><u>card/#card-layout</u></a><div class="alert alert-warning">card-columns is a special use case that will not suit most shops as card-columns is very difficult to layout and sort by...</div>', '8', '100', 'tep_cfg_select_option([\'card-group\', \'card-deck\', \'card-columns\'], ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Category Card Layout', 'MODULE_CONTENT_IN_CATEGORY_LISTING_LAYOUT', 'card-deck', 'What Layout suits your shop?  See <a target="_blank" href="https://getbootstrap.com/docs/4.4/components/card/#card-layout"><u>card/#card-layout</u></a><div class=\"alert alert-warning\">card-columns is a special use case that will not suit most shops as card-columns is very difficult to layout and sort by...</div>', '6', '3', 'tep_cfg_select_option([\'card-group\', \'card-deck\', \'card-columns\'], ', now());
