...
?>
    <div class="col-xs-6 text-right"><?php echo tep_draw_button(IMAGE_BUTTON_ADD_ADDRESS, 'glyphicon glyphicon-home', tep_href_link('address_book_process.php', '', 'SSL'), 'primary'); ?></div>
<?php
  }
?>
  </div>
