...
<div class="contentContainer">
  ...
  <h2 class="h4"><?php echo PRIMARY_ADDRESS_TITLE; ?></h2>
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="card mb-2 text-white bg-info">
        ...
        echo $customer->make_address_label($customer->get_default_address_id(), true, ' ', '<br />');
      ?></div>
      </div>
    </div>
  ...
  <h2 class="h4"><?php echo ADDRESS_BOOK_TITLE; ?></h2>
