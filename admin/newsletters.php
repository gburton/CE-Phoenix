    ...
    switch ($action) {
      ...
      case 'update':
        ...
        if ($newsletter_error == false) {
          ...
          tep_redirect(tep_href_link('newsletters.php', (isset($_GET['page']) ? 'page=' . $HTTP_GET_VARS['page'] . '&' : '') . 'nID=' . $newsletter_id));
        } else {
          $action = 'new';
        }
        break;
...
?>
      ...
      <tr><?php echo tep_draw_form('newsletter', 'newsletters.php', (isset($_GET['page']) ? 'page=' . $HTTP_GET_VARS['page'] . '&' : '') . 'action=' . $form_action); if ($form_action == 'update') echo tep_draw_hidden_field('newsletter_id', $nID); ?>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="smallText" align="right"><?php echo tep_draw_button(IMAGE_SAVE, 'disk', null, 'primary') . tep_draw_button(IMAGE_CANCEL, 'close', tep_href_link('newsletters.php', (isset($_GET['page']) ? 'page=' . $HTTP_GET_VARS['page'] . '&' : '') . (isset($_GET['nID']) ? 'nID=' . $HTTP_GET_VARS['nID'] : ''))); ?></td>
          </tr>
        </table></td>
      </form></tr>
<?php
