  ...
  class d_security_checks {
    ...
    function __construct() {
      ...
      if ( defined('MODULE_ADMIN_DASHBOARD_SECURITY_CHECKS_STATUS') ) {
        ...
        $this->content_width = (int)MODULE_ADMIN_DASHBOARD_SECURITY_CHECKS_CONTENT_WIDTH;
      }
    }
    ...
    function getOutput() {
      ...
      if (empty($secCheck_messages)) {
        $output .= '<div class="alert alert-success">';
          $output .= '<div class="clearfix"><i class="fas fa-5x fa-thumbs-up float-left mr-2"></i><strong>' . MODULE_ADMIN_DASHBOARD_SECURITY_CHECKS_SUCCESS . '</strong></div>';
        $output .= '</div>';
      }
    ...
    function install() {
      ...
      tep_db_query("insert into configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_ADMIN_DASHBOARD_SECURITY_CHECKS_SORT_ORDER', '600', 'Sort order of display. Lowest is displayed first.', '6', '0', now())");
    }
