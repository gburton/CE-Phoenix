...
const TABLE_HEADING_SORT_ORDERS = 'Sort Orders';
...
const TEXT_INFO_VERTICAL_SORT_ORDER = 'Vertical Sort Order:';
const TEXT_INFO_HORIZONTAL_SORT_ORDER = 'Horizontal Sort Order:';
const TEXT_INFO_WIDTH = 'Width (1-12 twelfths of the screen):';
