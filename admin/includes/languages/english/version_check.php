...
define('VERSION_UPGRADES_AVAILABLE', 'A new version is available for download! (CE Phoenix v%s)<hr><a class="alert-link" target="_blank" rel="noreferrer" href="https://phoenixcart.org/forum/viewtopic.php?f=26&t=309">Certified Developers</a> and detailed "<a class="alert-link" target="_blank" rel="noreferrer" href="https://phoenixcart.org/forum/app.php/tag/phoenix-update">Do It Yourself</a>" instructions are available in the Phoenix Club.');
