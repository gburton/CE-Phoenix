...
define('MODULE_ADMIN_DASHBOARD_LATEST_NEWS_FEED_ERROR', 'No se ha podido conectar a la fuente de noticias osCommerce. El siguiente intento se llevará a cabo dentro de 24 horas.');
define('MODULE_ADMIN_DASHBOARD_LATEST_NEWS_ICON_NEWSLETTER', 'Inscríbese para recibir el boletín osCommerce');
define('MODULE_ADMIN_DASHBOARD_LATEST_NEWS_ICON_FACEBOOK', 'Conviértese en un Fan de osCommerce en Facebook');
