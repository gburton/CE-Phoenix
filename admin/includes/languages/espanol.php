...
define('BOX_CATALOG_PRODUCTS_EXPECTED', 'Próximamente en existencia');
...
define('BOX_TOOLS_BANNER_MANAGER', 'Gestor de pancartas');
...
define('BOX_TOOLS_SEC_DIR_PERMISSIONS', 'Permisos de directorios');
...
define('JS_LAST_NAME', '* El campo \'Apellido\' debe tener al menos ' . ENTRY_LAST_NAME_MIN_LENGTH . ' caracteres.\n');
define('JS_DOB', '* El campo \'Fecha de Nacimiento\' debe tener el formato: xx/xx/xxxx (dia/mes/año).\n');
define('JS_EMAIL_ADDRESS', '* El campo \'Correo electrónico\' debe tener al menos ' . ENTRY_EMAIL_ADDRESS_MIN_LENGTH . ' caracteres.\n');
define('JS_ADDRESS', '* El campo \'Domicilio\' debe tener al menos ' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' caracteres.\n');
...
define('JS_ZONE', '* La \'Provincia\' se debe seleccionar de la lista de provincia para este país.');
...
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', '&nbsp;<span class="errorText">El correo electrónico ya existe!</span>');
...
define('IMAGE_NEW_BANNER', 'Nueva pancarta');
...
define('TEXT_DISPLAY_NUMBER_OF_BANNERS', 'Viendo del <b>%d</b> al <b>%d</b> (de <b>%d</b> pancartas)');
...
// seo helper
define('PLACEHOLDER_COMMA_SEPARATION', 'Debe,Ser,Separado,Por,Comas');
