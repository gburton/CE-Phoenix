...
<?php
  ...
  switch ($action) {
    case 'new':
      ...
      $contents[] = ['text' => TEXT_INFO_RATE_DESCRIPTION . '<br>' . tep_draw_input_field('tax_description')];
    ...
    case 'edit':
      ...
      $contents[] = ['text' => TEXT_INFO_RATE_DESCRIPTION . '<br>' . tep_draw_input_field('tax_description', $trInfo->tax_description)];
    ...
    default:
      if (is_object($trInfo)) {
        ...
        $contents[] = ['text' => TEXT_INFO_DATE_ADDED . ' ' . tep_date_short($trInfo->date_added)];
        $contents[] = ['text' => TEXT_INFO_LAST_MODIFIED . ' ' . tep_date_short($trInfo->last_modified)];
        $contents[] = ['text' => TEXT_INFO_RATE_DESCRIPTION . '<br>' . $trInfo->tax_description];
      }
      break;
  }
