  ...
  if ($action == 'edit') {
    ...
    echo tep_draw_form('pages', 'info_pages.php', 'page=' . (int)$_GET['page'] . '&pID=' . $_GET['pID'] . '&action=update', 'post', 'enctype="multipart/form-data"'); ?>
      ...
      <div class="form-group row align-items-center">
        <label class="col-form-label col-sm-3 text-left text-sm-right"><?php echo TEXT_PAGE_STATUS; ?></label>
        <div class="col-sm-9">
          <div class="custom-control custom-radio custom-control-inline">
            <?php echo tep_draw_selection_field('page_status', 'radio', '1', $in_status, 'id="inStatus" class="custom-control-input"'); ?>
            <label class="custom-control-label" for="inStatus"><?php echo TEXT_PAGE_PUBLISHED; ?></label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <?php echo tep_draw_selection_field('page_status', 'radio', '0', $out_status, 'id="outStatus" class="custom-control-input"'); ?>
            <label class="custom-control-label" for="outStatus"><?php echo TEXT_PAGE_NOT_PUBLISHED; ?></label>
          </div>
        </div>
      </div>
      ...
      <div class="form-group row">
        <label class="col-form-label col-sm-3 text-left text-sm-right"><?php echo NAVBAR_TITLE; ?></label>
        <div class="col-sm-9">
      ...
      <div class="form-group row">
        <label class="col-form-label col-sm-3 text-left text-sm-right"><?php echo PAGE_TITLE; ?></label>
        <div class="col-sm-9">
          <?php echo $page_title; ?>
        </div>
      </div>
      ...
      <div class="form-group row">
        <label class="col-form-label col-sm-3 text-left text-sm-right"><?php echo PAGE_TEXT; ?></label>
        <div class="col-sm-9">
          <?php echo $page_text; ?>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-9">
          <?php echo tep_draw_input_field('slug', $pInfo->slug, 'required aria-required="true" id="inputSlug" class="form-control w-50"'); ?>
        </div>
      </div>
    ...
    echo tep_draw_form('pages', 'info_pages.php', 'action=addnew', 'post', 'enctype="multipart/form-data"');
      ...
      <div class="form-group row align-items-center">
        ...
        <div class="col-sm-9">
          <div class="custom-control custom-radio custom-control-inline">
            <?php echo tep_draw_selection_field('page_status', 'radio', '1', 0, 'id="inStatus" class="custom-control-input"'); ?>
            <label class="custom-control-label" for="inStatus"><?php echo TEXT_PAGE_PUBLISHED; ?></label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <?php echo tep_draw_selection_field('page_status', 'radio', '0', 1, 'id="outStatus" class="custom-control-input"'); ?>
            <label class="custom-control-label" for="outStatus"><?php echo TEXT_PAGE_NOT_PUBLISHED; ?></label>
          </div>
        </div>
      </div>
      ...
      <div class="form-group row">
        <label for="inputSlug" class="col-form-label col-sm-3 text-left text-sm-right"><?php echo PAGE_SLUG; ?></label>
        <div class="col-sm-9">
          <?php echo tep_draw_input_field('slug', null, 'required aria-required="true" id="inputSlug" class="form-control w-50"'); ?>
        </div>
      </div>
    ...
    <div class="row no-gutters">
      <div class="col-12 col-sm-8">
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            <thead class="thead-dark">
              <tr>
                <th><?php echo TABLE_HEADING_PAGE_ID; ?></th>
                <th><?php echo TABLE_HEADING_PAGE_TITLE; ?></th>
                <th><?php echo TABLE_HEADING_SLUG; ?></th>
            ...
            <tbody>
              ...
              foreach ($pages as $k => $v) {
                ...
                ?>
                  <td><?php echo $v['pages_id']; ?></td>
                  <td><?php echo $v['pages_title']; ?></td>
                  <td><?php echo $v['slug']; ?></td>
                  <td><?php echo $v['date_added']; ?></td>                  
                  <td class="text-center"><?php echo $v['sort_order']; ?>&nbsp;</td>
        ...
        <div class="row my-1">
          ...
          <div class="col text-right mr-2"><?php echo $pages_split->display_links($pages_query_numrows, MAX_DISPLAY_SEARCH_RESULTS, MAX_DISPLAY_PAGE_LINKS, $_GET['page']); ?></div>
        </div>
