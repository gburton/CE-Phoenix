      ...
      if ( isset($mInfo) ) {
        ...
        if ($action == 'list_new') {
          ...
          if (isset($mInfo->signature) && (list($scode, $smodule, $sversion, $soscversion) = explode('|', $mInfo->signature))) {
            $contents[] = ['text' => '<i class="fas fa-info-circle text-muted"></i> <strong>' . TEXT_INFO_VERSION . '</strong> ' . $sversion . ' (<a href="http://sig.oscommerce.com/' . $mInfo->signature . '" target="_blank" rel="noreferrer" rel="noreferrer">' . TEXT_INFO_ONLINE_STATUS . '</a>)'];
          }
          ...
          if (isset($mInfo->signature) && (list($scode, $smodule, $sversion, $soscversion) = explode('|', $mInfo->signature))) {
            $contents[] = ['text' => '<i class="fas fa-info-circle text-muted"></i> <strong>' . TEXT_INFO_VERSION . '</strong> ' . $sversion . ' (<a href="http://sig.oscommerce.com/' . $mInfo->signature . '" target="_blank" rel="noreferrer">' . TEXT_INFO_ONLINE_STATUS . '</a>)'];
          }
