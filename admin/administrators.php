  ...
  if (tep_not_null($action)) {
    switch ($action) {
      ...
      case 'save':
        ...
        $check_query = tep_db_query("select id, user_name from " . administrators . " where id = '" . (int)$HTTP_GET_VARS['aID'] . "'");
...
// update username in htpasswd if changed
        ...
        tep_db_query("update " . administrators . " set user_name = '" . tep_db_input($username) . "' where id = '" . (int)$HTTP_GET_VARS['aID'] . "'");
...
// update password in htpasswd
          ...
          tep_db_query("update " . administrators . " set user_password = '" . tep_db_input(tep_encrypt_password($password)) . "' where id = '" . (int)$HTTP_GET_VARS['aID'] . "'");
...
// write new htpasswd file
        ...
        tep_redirect(tep_href_link('administrators.php', 'aID=' . (int)$HTTP_GET_VARS['aID']));
        break;
      case 'deleteconfirm':
