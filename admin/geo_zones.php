...
*/
  ...
  $saction = (isset($_GET['saction']) ? $HTTP_GET_VARS['saction'] : '');
  ...
  if ($action == 'list') {
    switch ($saction) {
      case 'new':
        ...
        $contents = array('form' => tep_draw_form('zones', 'geo_zones.php', 'zpage=' . $HTTP_GET_VARS['zpage'] . '&zID=' . $HTTP_GET_VARS['zID'] . '&action=list&spage=' . $HTTP_GET_VARS['spage'] . '&' . (isset($_GET['sID']) ? 'sID=' . $HTTP_GET_VARS['sID'] . '&' : '') . 'saction=insert_sub'));
        ...
        $contents[] = array('align' => 'center', 'text' => '<br />' . tep_draw_button(IMAGE_SAVE, 'disk', null, 'primary') . tep_draw_button(IMAGE_CANCEL, 'close', tep_href_link('geo_zones.php', 'zpage=' . $HTTP_GET_VARS['zpage'] . '&zID=' . $HTTP_GET_VARS['zID'] . '&action=list&spage=' . $HTTP_GET_VARS['spage'] . '&' . (isset($_GET['sID']) ? 'sID=' . $HTTP_GET_VARS['sID'] : ''))));
        break;
      case 'edit':
