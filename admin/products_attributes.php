...
*/
  ...
  $option_page = (isset($_GET['option_page']) && is_numeric($_GET['option_page'])) ? $HTTP_GET_VARS['option_page'] : 1;
  $value_page = (isset($_GET['value_page']) && is_numeric($_GET['value_page'])) ? $HTTP_GET_VARS['value_page'] : 1;
  $attribute_page = (isset($_GET['attribute_page']) && is_numeric($_GET['attribute_page'])) ? $HTTP_GET_VARS['attribute_page'] : 1;
